//http://forum.43oh.com/topic/3314-energia-library-onewire-ds18b20-430-stellaris/#entry29104
// StellarisOW
...
byte loadTemperature(uint8_t ROMno){
  return result[ROMno];
}
